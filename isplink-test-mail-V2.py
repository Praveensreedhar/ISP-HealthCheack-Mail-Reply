...
os.chdir("C:\\Users\\AXTON\\Desktop\\ISP-Link-Test")
...
for device in devices:
    ...
    if rpm > 0:
        ...
        try:
            ...
            ping_result = net_connect.send_command("ping 10.1.1.2 count 5")
            print(ping_result)
            time.sleep(10)
		...
		"""                    
                ...
                smtp_port = 587
                smtp_username = "xyza@gmail.com"
                smtp_password = "123z"
                sender_email = 'zsc@mail.com, cde@mail.com'
                with smtplib.SMTP(smtp_server, smtp_port) as server:
                    server.starttls()
                    server.login(smtp_username, smtp_password)
                    msg = MIMEText(reply_message)
                    msg['Subject'] = replay_subject
    ...
    #hostname = "TRV-TATA"
       ...
       print("TRV-MAA-IPLC CKTid:123987 is UP now  ")
